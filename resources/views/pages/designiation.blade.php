                                             ...
                                             <div class="form-group row">
                                              <div class="col-lg-6">
                                               ...
                                               <span class="form-text text-muted">Please enter the name</span>
                                                ...
                                                <div class="col-lg-6">
                                                  <label>image</label>
                                                  <input type="file"  accept="image/*"  name="path"  class="form-control" placeholder="Upload the Image"/>
                                                  <span class="form-text text-muted">Please upload your Image File</span>
                                                </div>
                                             </div>
                                             <div class="form-group row">
                                              <div class="col-lg-6">
